            ...
            @if (auth()->user()->role !== 'employee')
                <div class="flex items-center gap-2">
                    <button wire:click="exportCsv"
                            class="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-slate-600 rounded-lg text-xs font-medium text-slate-300 hover:text-white transition-all duration-150 cursor-pointer">
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
            @if ($timeLogs->isEmpty())
                <div class="flex flex-col items-center justify-center py-16 text-slate-600">
                    ...
                    <p class="text-sm">Belum ada data time log ditemukan.</p>
                </div>
            @else
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
