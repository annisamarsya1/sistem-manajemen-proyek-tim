<div>
    ...
    <button
        ...
        class="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold rounded-xl transition-all duration-150 cursor-pointer">
                ...
                <form wire:submit="saveTimeLog" class="px-6 py-5 space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="w-full px-3 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm text-slate-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all @error('projectId') border-rose-500/60 @enderror">
                    ...
                    <div>
                        ...
                        <select
                            wire:model="taskId"
                            @disabled($projectId === '')
                            class="w-full px-3 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm text-slate-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all disabled:opacity-40 disabled:cursor-not-allowed @error('taskId') border-rose-500/60 @enderror">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="w-full px-3 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm text-slate-300 placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all resize-none"></textarea>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-1">
                        ...
                        <button
                            ...
                            class="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 text-white text-sm font-semibold rounded-lg transition-all cursor-pointer">
